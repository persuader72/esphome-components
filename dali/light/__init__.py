...
from esphome.components import dali
...
from .. import CONF_DALI_ID, DALIComponent, dali_ns
...
}).extend(cv.COMPONENT_SCHEMA).extend(dali.dali_device_schema(0x20))
...
def to_code(config):
    ...
    yield dali.register_dali_device(var, config)
